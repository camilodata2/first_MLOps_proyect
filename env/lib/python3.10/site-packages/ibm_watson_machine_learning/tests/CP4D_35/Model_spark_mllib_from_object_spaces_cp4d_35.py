...
class TestWMLClientWithSpark(unittest.TestCase):
    ...
    def test_02_publish_model(self):
        ...
        sw_spec_id = self.client.software_specifications.get_id_by_name('spark-mllib_2.4-py37')
        ...
        TestWMLClientWithSpark.model_uid = self.client.repository.get_model_id(published_model)
