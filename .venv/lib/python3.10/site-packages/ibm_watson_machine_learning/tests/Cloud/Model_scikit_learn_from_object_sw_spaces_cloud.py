...
class TestWMLClientWithScikitLearn(unittest.TestCase):
    ...
    def test_04a_get_model_details(self):
    ...
    def test_04b_get_models_details_sync(self):
        TestWMLClientWithScikitLearn.logger.info("Get all models details sync")
        details = self.client.repository.get_model_details()
        print(details)

        details = self.client.repository.get_model_details(limit=10)
        print(details)

    def test_04c_get_models_details_async(self):
        TestWMLClientWithScikitLearn.logger.info("Get all models details async")
        for details in self.client.repository.get_model_details(limit=10, asynchronous=True,
                                                                get_all=True):
            print(details)

    def test_04d_list_models_sync(self):
        TestWMLClientWithScikitLearn.logger.info("List models sync")
        self.client.repository.list_models()
        self.client.repository.list_models(limit=10)

    def test_04e_list_models_async(self):
        TestWMLClientWithScikitLearn.logger.info("List models async")
        [details for details in self.client.repository.list_models(limit=10, asynchronous=True,
                                                                   get_all=True)]
